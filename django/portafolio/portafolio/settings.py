...
SECRET_KEY = 'django-insecure-rdg!+*c5tx=^09js!&2if!d^ql*21eggmmz9is78e(lji^gh@n'
...
DATABASES = {
    'default': {
        'ENGINE':'postgresql://postgres:up7scly5DQqkBMN5uLQk@containers-us-west-32.railway.app:5880/railway',
        'NAME': 'railway',
        'USER':'postgres',
        'PASSWORD':'up7scly5DQqkBMN5uLQk',
